...
model = keras.models.load_model(r"C:\Users\SILIVERU AKASH DURGA\Urban_Traffic_Control\urban_traffic_model_2.h5",compile=False)
...
def result(arr):
    ...
    dic[8]='Siren'
    dic[9]='Street Music'
    res=f"Pure Prediction: {dic[arr[0]]}\nAugmented Prediction(with noise): {dic[arr[1]]}\nAugmented Prediction(with stretch and pitch): {dic[arr[2]]}"
